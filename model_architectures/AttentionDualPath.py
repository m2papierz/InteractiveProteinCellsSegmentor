...
from model_architectures.attention_module import conv_block_attention_module
...
def conv2d_block(input_tensor: tf.Tensor, n_filters: int) -> tf.Tensor:
    ...
    :param n_filters: number of filters in the block layers
...
def con2d_down_block(input_tensor: tf.Tensor, n_filters: int) -> tf.Tensor:
    """
...
def con2d_up_block(input_tensor: tf.Tensor, n_filters: int, attention=False) -> tf.Tensor:
    """
    Up-sampling convolutional block.

    :param input_tensor: input tensor of the convolutional block
    :param n_filters: number of filters in the convolutional layer
    :param attention: flag indicating if to incorporate attention module
    ...
    x1 = Conv2DTranspose(filters=n_filters, kernel_size=(1, 1), strides=(2, 2), kernel_initializer="he_normal",
